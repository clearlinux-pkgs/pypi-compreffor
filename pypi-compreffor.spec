...
Source0  : https://files.pythonhosted.org/packages/2c/55/8835ade36a575c072fcb3e7f0daf7dc7061d5f9170a374afaaccecc28cda/compreffor-0.5.2.tar.gz
...
%prep
%setup -q -n compreffor-0.5.2
cd %{_builddir}/compreffor-0.5.2
pushd ..
cp -a compreffor-0.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656366688
...
cp %{_builddir}/compreffor-0.5.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-compreffor/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/compreffor-0.5.2/src/cxx/mingw-std-threads/LICENSE %{buildroot}/usr/share/package-licenses/pypi-compreffor/dd7d2e4f4bde0bf9e83138927fc7df466377a015
